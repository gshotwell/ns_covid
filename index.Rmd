...
if (nrow(today) == 0 ||
  ...
  if (is.na(manual)) {
    ...
    covid$change_tests[lgl] <- 7289
    covid$change_vaccinations <- 15000 
...
ggplot(vaccines, aes(x = date, y = immune)) + 
  ...
  labs (title = "Nova Scotia Aggregate immunity",
        subtitle = "Based on an expected 86% reduction in transmission 14 days after first dose",
