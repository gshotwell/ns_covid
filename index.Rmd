...
Nova Scotia administered **`r scales::comma(recent_vax)`** yesterday.
...
ggplot(vaccines, aes(x = date, y = immune)) + 
  ...
  labs (title = "Nova Scotia Aggregate immunity",
        subtitle = "Based on an expected 87% reduction in transmission 14 days after first dose",
